...
public class Team7104ScoopDaniel extends Team7104Hardware
{
    ...
    void ScoopPresets (float ScoopPresetTarget)
    {
        ...
        else
        {
            ...
            This doesn't appear right and is causing errors.
            */
    ...
    public void loop() {
        ...
        if (gamepad2.a)
        {
            ScoopPresets(150);      //Preset for Collecting Debris
        }

        if (gamepad2.b)
        {
            ScoopPresets(500);      //Preset for Dumping Debris into Conveyor
        }

        if (gamepad2.y)
        {
            ScoopPresets(-200);      //Preset for Storage
        }
